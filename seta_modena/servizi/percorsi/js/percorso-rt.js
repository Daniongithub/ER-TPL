...
function caricadati(){
    ...
    .then(data => {
        ...
        item.arrivals.forEach(element => {
            ...
            thead.innerHTML = `
                <tr>
                    <th class="linea" style="text-align:center;" colspan="2"><a href="/seta_modena/servizi/cercaorario/fermata.html?code=${element.wp_code}" class="bianco">${element.desc}</a></th>
                </tr>
            `;
